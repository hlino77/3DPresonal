...
CState_Madara_Attack_TurnKick_Server::CState_Madara_Attack_TurnKick_Server(const wstring& strStateName, class CBoss_Madara_Server* pBoss)
	:CState(strStateName)
	, m_pBoss(pBoss)
{
}

CState_Madara_Attack_TurnKick_Server::CState_Madara_Attack_TurnKick_Server(const CState& rhs, class CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}
HRESULT CState_Madara_Attack_TurnKick_Server::Initialize()
{
...
void CState_Madara_Attack_TurnKick_Server::Enter_State()
{
...
void CState_Madara_Attack_TurnKick_Server::Tick_State(_float fTimeDelta)
{
	...
	{
		m_pBoss->Set_State(L"Attack_DoubleTurnKick");
	}
...
void CState_Madara_Attack_TurnKick_Server::Exit_State()
{
...
void CState_Madara_Attack_TurnKick_Server::Update_Collider(_float fTimeDelta, _uint iColliderFrame, COLLIDER_ATTACK eAttackType)
{
	CModel* pBossModel = m_pBoss->Get_ModelCom();
...
void CState_Madara_Attack_TurnKick_Server::Follow_TargetPos(_float fTimeDelta)
{
...
void CState_Madara_Attack_TurnKick_Server::Free()
{
	__super::Free();
}
