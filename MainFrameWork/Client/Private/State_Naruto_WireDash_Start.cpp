...
CState_Naruto_WireDash_Start::CState_Naruto_WireDash_Start(const wstring& strStateName, CPlayer_Naruto* pPlayer)
	:CState(strStateName)
	, m_pPlayer(pPlayer)
{
}

CState_Naruto_WireDash_Start::CState_Naruto_WireDash_Start(const CState& rhs, CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}

HRESULT CState_Naruto_WireDash_Start::Initialize()
{
	...
	if(m_pPlayer->Is_Control())
		m_TickFunc = &CState_Naruto_WireDash_Start::Tick_State_Control;
	else
		m_TickFunc = &CState_Naruto_WireDash_Start::Tick_State_NoneControl;


	return S_OK;
}

void CState_Naruto_WireDash_Start::Enter_State()
{
...
void CState_Naruto_WireDash_Start::Tick_State(_float fTimeDelta)
{
	m_TickFunc(*this, fTimeDelta);
}

void CState_Naruto_WireDash_Start::Exit_State()
{
...
void CState_Naruto_WireDash_Start::Tick_State_NoneControl(_float fTimeDelta)
{
	CModel* pPlayerModel = m_pPlayer->Get_ModelCom();
...
void CState_Naruto_WireDash_Start::Free()
{
	__super::Free();
}
