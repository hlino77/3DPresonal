...
CState_Naruto_WireDash_Loop::CState_Naruto_WireDash_Loop(const CState& rhs, CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}

HRESULT CState_Naruto_WireDash_Loop::Initialize()
{
	...
	if(m_pPlayer->Is_Control())
		m_TickFunc = &CState_Naruto_WireDash_Loop::Tick_State_Control;
	else
		m_TickFunc = &CState_Naruto_WireDash_Loop::Tick_State_NoneControl;
...
void CState_Naruto_WireDash_Loop::Exit_State()
{
...
void CState_Naruto_WireDash_Loop::Tick_State_NoneControl(_float fTimeDelta)
{
	CTransform* pTransform = m_pPlayer->Get_TransformCom();
...
void CState_Naruto_WireDash_Loop::Free()
{
	__super::Free();
}
