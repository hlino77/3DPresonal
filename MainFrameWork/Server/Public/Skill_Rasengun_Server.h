...
BEGIN(Server)
class CSkill_Rasengun_Server : public CSkill_Server
{
protected:
	CSkill_Rasengun_Server(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CSkill_Rasengun_Server(const CSkill_Rasengun_Server& rhs);
	virtual ~CSkill_Rasengun_Server() = default;
...
public:
	static	CSkill_Rasengun_Server* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
