...
{
	m_iAnimIndex = m_pPlayer->Get_ModelCom()->Initailize_FindAnimation(L"Attack_cmb01", 2.0f);
...
void CState_Sasuke_Attack_cmb01::Update_Collider(_float fTimeDelta)
{
	CModel* pPlayerModel = m_pPlayer->Get_ModelCom();
...
void CState_Sasuke_Attack_cmb01::Set_TargetPos()
{
...
void CState_Sasuke_Attack_cmb01::Follow_TargetPos(_float fTimeDelta)
{
