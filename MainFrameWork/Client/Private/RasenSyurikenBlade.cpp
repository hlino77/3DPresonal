...
CRasenSyurikenBlade::CRasenSyurikenBlade(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CEffect(pDevice, pContext)
{
}

CRasenSyurikenBlade::CRasenSyurikenBlade(const CRasenSyurikenBlade& rhs)
	: CEffect(rhs)
{
}

HRESULT CRasenSyurikenBlade::Initialize_Prototype()
{
	
	return S_OK;
}

HRESULT CRasenSyurikenBlade::Initialize(void* pArg)
{
	__super::Initialize(pArg);


	m_szModelName = L"Effect_Meteor_RasenSyurikenBlade";
...
void CRasenSyurikenBlade::Tick(_float fTimeDelta)
{
...
void CRasenSyurikenBlade::LateTick(_float fTimeDelta)
{
	m_pRendererCom->Add_RenderGroup(CRenderer::RENDER_BLEND, this);
}

HRESULT CRasenSyurikenBlade::Render()
{
...
void CRasenSyurikenBlade::Appear()
{
	m_bActive = true;
...
void CRasenSyurikenBlade::DisAppear()
{
	Set_Active(false);
}


HRESULT CRasenSyurikenBlade::Ready_Components()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
	...
	///* For.Com_Model */
	wstring strComName = L"Prototype_Component_Model_RasenSyurikenBlade";
...
void CRasenSyurikenBlade::Update_Transform(_float fTimeDelta)
{
...
CGameObject* CRasenSyurikenBlade::Clone(void* pArg)
{
	CRasenSyurikenBlade* pInstance = new CRasenSyurikenBlade(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Cloned : CRasenSyurikenBlade");
...
CRasenSyurikenBlade* CRasenSyurikenBlade::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CRasenSyurikenBlade* pInstance = new CRasenSyurikenBlade(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CRasenSyurikenBlade");
		Safe_Release(pInstance);
	}
