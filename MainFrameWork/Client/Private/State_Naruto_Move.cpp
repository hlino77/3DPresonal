...
CState_Naruto_Move::CState_Naruto_Move(const wstring& strStateName, class CPlayer_Naruto* pPlayer)
	:CState(strStateName)
	, m_pPlayer(pPlayer)
{
}

CState_Naruto_Move::CState_Naruto_Move(const CState& rhs, class CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}

HRESULT CState_Naruto_Move::Initialize()
{
...
void CState_Naruto_Move::Enter_State()
{
	m_eState = RUNSTART;
...
void CState_Naruto_Move::Tick_State(_float fTimeDelta)
{
	switch (m_eState)
	{
	case RUNSTART:
...
void CState_Naruto_Move::Exit_State()
{
	m_eState = RUNEND;
	m_bStop = false;
}

void CState_Naruto_Move::UpdateMove(_float fTimeDelta)
{
...
void CState_Naruto_Move::UpdateEnd(_float fTimeDelta)
{
	if (m_bStop)
	{
