...
CRasengan_StartSmoke::CRasengan_StartSmoke(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CEffect(pDevice, pContext)
{
}

CRasengan_StartSmoke::CRasengan_StartSmoke(const CRasengan_StartSmoke& rhs)
	: CEffect(rhs)
{
}

HRESULT CRasengan_StartSmoke::Initialize_Prototype()
{
	
	return S_OK;
}

HRESULT CRasengan_StartSmoke::Initialize(void* pArg)
{
	__super::Initialize(pArg);


	m_szModelName = L"Effect_Rasengan_StartSmoke";
...
void CRasengan_StartSmoke::Tick(_float fTimeDelta)
{
...
void CRasengan_StartSmoke::LateTick(_float fTimeDelta)
{
	m_pRendererCom->Add_RenderGroup(CRenderer::RENDER_MODELEFFECT_INSTANCE, this);
}

HRESULT CRasengan_StartSmoke::Render()
{
	
	return S_OK;
}

HRESULT CRasengan_StartSmoke::Render_Instance(ID3D11Buffer* pInstanceBuffer, _uint iSize)
{
...
void CRasengan_StartSmoke::Add_InstanceData(vector<Vec4>& BufferData)
{
...
void CRasengan_StartSmoke::Appear()
{
	m_bActive = true;
...
void CRasengan_StartSmoke::DisAppear()
{
	m_bEnd = true;
}
...
void CRasengan_StartSmoke::BillBoard()
{
...
HRESULT CRasengan_StartSmoke::Ready_Components()
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
	...
	///* For.Com_Model */
	wstring strComName = L"Prototype_Component_Model_RasenganStartSmoke";
...
CGameObject* CRasengan_StartSmoke::Clone(void* pArg)
{
	CRasengan_StartSmoke* pInstance = new CRasengan_StartSmoke(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Cloned : CRasengan_StartSmoke");
...
CRasengan_StartSmoke* CRasengan_StartSmoke::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CRasengan_StartSmoke* pInstance = new CRasengan_StartSmoke(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CRasengan_StartSmoke");
		Safe_Release(pInstance);
	}
...
void CRasengan_StartSmoke::Free()
{
	__super::Free();
}
