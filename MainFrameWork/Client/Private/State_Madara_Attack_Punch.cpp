...
CState_Madara_Attack_Punch::CState_Madara_Attack_Punch(const wstring& strStateName, class CBoss_Madara* pBoss)
	:CState(strStateName)
	, m_pBoss(pBoss)
{
}

CState_Madara_Attack_Punch::CState_Madara_Attack_Punch(const CState& rhs, class CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}
HRESULT CState_Madara_Attack_Punch::Initialize()
{
...
void CState_Madara_Attack_Punch::Exit_State()
{

}

void CState_Madara_Attack_Punch::Follow_TargetPos(_float fTimeDelta)
{
...
void CState_Madara_Attack_Punch::Free()
{
	__super::Free();
}
