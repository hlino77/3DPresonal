...
class CState_Madara_Attack_TurnKick_Server : public CState
{
public:
	CState_Madara_Attack_TurnKick_Server(const wstring& strStateName, class CBoss_Madara_Server* pBoss);
	CState_Madara_Attack_TurnKick_Server(const CState& rhs, class CStateMachine* pMachine);
	virtual ~CState_Madara_Attack_TurnKick_Server() = default;
