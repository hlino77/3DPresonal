...
CState_Madara_HitMiddle_Server::CState_Madara_HitMiddle_Server(const wstring& strStateName, class CBoss_Madara_Server* pBoss)
	:CState(strStateName)
	, m_pBoss(pBoss)
{
}

CState_Madara_HitMiddle_Server::CState_Madara_HitMiddle_Server(const CState& rhs, class CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}
HRESULT CState_Madara_HitMiddle_Server::Initialize()
{
...
void CState_Madara_HitMiddle_Server::Enter_State()
{
	m_pBoss->Reserve_Animation(m_iAnimIndex, 0.1f, 2, 0);
	m_bKnockBack = false;
}

void CState_Madara_HitMiddle_Server::Tick_State(_float fTimeDelta)
{
	if (!m_bKnockBack)
		Knock_Back();
...
void CState_Madara_HitMiddle_Server::Exit_State()
{
	m_vHitPos = Vec3(0.0f, 0.0f, 0.0f);
}

void CState_Madara_HitMiddle_Server::Knock_Back()
{
...
void CState_Madara_HitMiddle_Server::LookAt_HitObject(_float fTimeDelta)
{
...
void CState_Madara_HitMiddle_Server::Free()
{
	__super::Free();
}
