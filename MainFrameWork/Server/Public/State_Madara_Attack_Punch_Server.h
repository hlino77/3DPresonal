...
class CState_Madara_Attack_Punch_Server : public CState
{
public:
	CState_Madara_Attack_Punch_Server(const wstring& strStateName, class CBoss_Madara_Server* pBoss);
	CState_Madara_Attack_Punch_Server(const CState& rhs, class CStateMachine* pMachine);
	virtual ~CState_Madara_Attack_Punch_Server() = default;
