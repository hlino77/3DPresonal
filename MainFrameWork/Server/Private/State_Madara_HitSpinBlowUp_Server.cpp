...
CState_Madara_HitSpinBlowUp_Server::CState_Madara_HitSpinBlowUp_Server(const wstring& strStateName, CBoss_Madara_Server* pBoss)
	:CState(strStateName)
	, m_pBoss(pBoss)
{
}

CState_Madara_HitSpinBlowUp_Server::CState_Madara_HitSpinBlowUp_Server(const CState& rhs, CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}

HRESULT CState_Madara_HitSpinBlowUp_Server::Initialize()
{
...
void CState_Madara_HitSpinBlowUp_Server::Enter_State()
{
	m_pBoss->Reserve_Animation(m_iAnimIndex, 0.1f, 0, 0);
	m_bKnockBack = false;
}

void CState_Madara_HitSpinBlowUp_Server::Tick_State(_float fTimeDelta)
{
	if (!m_bKnockBack)
		Knock_Back();
...
void CState_Madara_HitSpinBlowUp_Server::Exit_State()
{

}


void CState_Madara_HitSpinBlowUp_Server::Knock_Back()
{
...
void CState_Madara_HitSpinBlowUp_Server::LookAt_HitObject(_float fTimeDelta)
{
...
void CState_Madara_HitSpinBlowUp_Server::Free()
{
	__super::Free();
}
