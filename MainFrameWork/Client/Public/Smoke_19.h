...
class CSmoke_19 : public CEffect
{
	// CGameObject을(를) 통해 상속됨

private:
	/* 원형을 생성할 때 */
	CSmoke_19(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	/* 사본을 생성할 때 */
	CSmoke_19(const CSmoke_19& rhs); /* 복사 생성자. */
	virtual ~CSmoke_19() = default;
...
public:
	...
	static CSmoke_19* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
