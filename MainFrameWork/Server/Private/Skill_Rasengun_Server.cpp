...
CSkill_Rasengun_Server::CSkill_Rasengun_Server(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CSkill_Server(pDevice, pContext)
{
}

CSkill_Rasengun_Server::CSkill_Rasengun_Server(const CSkill_Rasengun_Server& rhs)
	: CSkill_Server(rhs)
{
}

HRESULT CSkill_Rasengun_Server::Initialize_Prototype()
{
...
HRESULT CSkill_Rasengun_Server::Initialize(void* pArg)
{
...
void CSkill_Rasengun_Server::Tick(_float fTimeDelta)
{
	__super::Tick(fTimeDelta);

}

void CSkill_Rasengun_Server::LateTick(_float fTimeDelta)
{
...
HRESULT CSkill_Rasengun_Server::Render()
{
	return S_OK;
}

void CSkill_Rasengun_Server::OnCollisionEnter(const _uint iColLayer, CCollider* pOther)
{
...
void CSkill_Rasengun_Server::OnCollisionStay(const _uint iColLayer, CCollider* pOther)
{
	
}

void CSkill_Rasengun_Server::OnCollisionExit(const _uint iColLayer, CCollider* pOther)
{
	if (iColLayer == (_uint)LAYER_COLLIDER::LAYER_ATTACK)
	{
		if (pOther->Get_Owner()->Get_ObjectType() == OBJ_TYPE::MONSTER || pOther->Get_Owner()->Get_ObjectType() == OBJ_TYPE::BOSS)
...
HRESULT CSkill_Rasengun_Server::Ready_Coliders()
{
...
void CSkill_Rasengun_Server::Send_SkillInfo()
{
...
void CSkill_Rasengun_Server::Explosion()
{
	m_bExplosion = true;
...
HRESULT CSkill_Rasengun_Server::Ready_Components()
{
...
CSkill_Rasengun_Server* CSkill_Rasengun_Server::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CSkill_Rasengun_Server* pInstance = new CSkill_Rasengun_Server(pDevice, pContext);
...
CGameObject* CSkill_Rasengun_Server::Clone(void* pArg)
{
	CSkill_Rasengun_Server* pInstance = new CSkill_Rasengun_Server(*this);
...
void CSkill_Rasengun_Server::Free()
{
	__super::Free();
}
