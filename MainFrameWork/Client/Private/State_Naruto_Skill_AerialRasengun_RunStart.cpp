...
CState_Naruto_Skill_AerialRasengun_RunStart::CState_Naruto_Skill_AerialRasengun_RunStart(const wstring& strStateName, CPlayer_Naruto* pPlayer)
	:CState(strStateName)
	, m_pPlayer(pPlayer)
{
}

CState_Naruto_Skill_AerialRasengun_RunStart::CState_Naruto_Skill_AerialRasengun_RunStart(const CState& rhs, CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}

HRESULT CState_Naruto_Skill_AerialRasengun_RunStart::Initialize()
{
	m_iAnimIndex = m_pPlayer->Get_ModelCom()->Initailize_FindAnimation(L"Ninjutsu_Aerial_Rasengan_Start", 1.5f);

	if (m_iAnimIndex == -1)
		return E_FAIL;

	if(m_pPlayer->Is_Control())
		m_TickFunc = &CState_Naruto_Skill_AerialRasengun_RunStart::Tick_State_Control;
	else
		m_TickFunc = &CState_Naruto_Skill_AerialRasengun_RunStart::Tick_State_NoneControl;


	return S_OK;
}

void CState_Naruto_Skill_AerialRasengun_RunStart::Enter_State()
{
	Set_NearTarget();
...
void CState_Naruto_Skill_AerialRasengun_RunStart::Tick_State(_float fTimeDelta)
{
	m_TickFunc(*this, fTimeDelta);
}

void CState_Naruto_Skill_AerialRasengun_RunStart::Exit_State()
{

}

void CState_Naruto_Skill_AerialRasengun_RunStart::Tick_State_Control(_float fTimeDelta)
{
	...
	if (pPlayerModel->Is_AnimationEnd(m_iAnimIndex))
	{
		...
		{
			m_pPlayer->Set_State(L"AerialRasengun_RunLoop");
			return;
		}
	}
...
void CState_Naruto_Skill_AerialRasengun_RunStart::Tick_State_NoneControl(_float fTimeDelta)
{
	Follow_Target(fTimeDelta);
...
void CState_Naruto_Skill_AerialRasengun_RunStart::Free()
{
	__super::Free();
}

void CState_Naruto_Skill_AerialRasengun_RunStart::Set_NearTarget()
{
...
void CState_Naruto_Skill_AerialRasengun_RunStart::Follow_Target(_float fTimeDelta)
{
