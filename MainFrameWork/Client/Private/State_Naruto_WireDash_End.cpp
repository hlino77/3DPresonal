...
CState_Naruto_WireDash_End::CState_Naruto_WireDash_End(const wstring& strStateName, class CPlayer_Naruto* pPlayer)
	:CState(strStateName)
	, m_pPlayer(pPlayer)
{
}

CState_Naruto_WireDash_End::CState_Naruto_WireDash_End(const CState& rhs, class CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}

HRESULT CState_Naruto_WireDash_End::Initialize()
{
	...
	if (m_pPlayer->Is_Control())
		m_TickFunc = &CState_Naruto_WireDash_End::Tick_State_Control;
	else
		m_TickFunc = &CState_Naruto_WireDash_End::Tick_State_NoneControl;

	return S_OK;
}

void CState_Naruto_WireDash_End::Enter_State()
{
...
void CState_Naruto_WireDash_End::Tick_State(_float fTimeDelta)
{
	m_TickFunc(*this, fTimeDelta);
}

void CState_Naruto_WireDash_End::Exit_State()
{
	m_pPlayer->Get_WireTrail()->Set_Active(false);
}

void CState_Naruto_WireDash_End::Tick_State_Control(_float fTimeDelta)
{
...
void CState_Naruto_WireDash_End::Tick_State_NoneControl(_float fTimeDelta)
{
	m_pPlayer->Follow_ServerPos(0.01f, 6.0f * fTimeDelta);
}

void CState_Naruto_WireDash_End::Free()
{
	__super::Free();
}
