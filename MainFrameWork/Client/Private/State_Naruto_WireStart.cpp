...
CState_Naruto_WireStart::CState_Naruto_WireStart(const wstring& strStateName, CPlayer_Naruto* pPlayer)
	:CState(strStateName)
	, m_pPlayer(pPlayer)
{
}

CState_Naruto_WireStart::CState_Naruto_WireStart(const CState& rhs, CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}

HRESULT CState_Naruto_WireStart::Initialize()
{
	...
	if(m_pPlayer->Is_Control())
		m_TickFunc = &CState_Naruto_WireStart::Tick_State_Control;
	else
		m_TickFunc = &CState_Naruto_WireStart::Tick_State_NoneControl;


	return S_OK;
}

void CState_Naruto_WireStart::Enter_State()
{
...
void CState_Naruto_WireStart::Exit_State()
{
...
void CState_Naruto_WireStart::Tick_State_Control(_float fTimeDelta)
{
...
void CState_Naruto_WireStart::Tick_State_NoneControl(_float fTimeDelta)
{
	CModel* pPlayerModel = m_pPlayer->Get_ModelCom();
	_uint iFrame = pPlayerModel->Get_Anim_Frame(m_iAnimIndex);
...
_bool CState_Naruto_WireStart::WirePicking()
{
	_bool bPick = false;
...
void CState_Naruto_WireStart::Free()
{
	__super::Free();
}
