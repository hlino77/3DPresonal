...
{
	m_iAnimIndex = m_pMonster->Get_ModelCom()->Initailize_FindAnimation(L"Attack_Punch", 1.2f);
...
void CState_WhiteZetsu_Attack_Punch_Server::Update_Collider(_float fTimeDelta)
{
