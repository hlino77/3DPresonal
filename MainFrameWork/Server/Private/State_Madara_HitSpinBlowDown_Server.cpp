...
CState_Madara_HitSpinBlowDown_Server::CState_Madara_HitSpinBlowDown_Server(const wstring& strStateName, class CBoss_Madara_Server* pBoss)
	:CState(strStateName)
	, m_pBoss(pBoss)
{
}

CState_Madara_HitSpinBlowDown_Server::CState_Madara_HitSpinBlowDown_Server(const CState& rhs, class CStateMachine* pMachine)
	:CState(rhs, pMachine)
{
}
HRESULT CState_Madara_HitSpinBlowDown_Server::Initialize()
{
...
void CState_Madara_HitSpinBlowDown_Server::Enter_State()
{
...
void CState_Madara_HitSpinBlowDown_Server::Tick_State(_float fTimeDelta)
{
	if (!m_bKnockBack)
		Knock_Back();
...
void CState_Madara_HitSpinBlowDown_Server::Exit_State()
{
	m_vHitPos = Vec3(0.0f, 0.0f, 0.0f);
	m_pBoss->Get_RigidBody()->Set_GruondDrag(m_fOriginDrag);
}

void CState_Madara_HitSpinBlowDown_Server::Knock_Back()
{
...
void CState_Madara_HitSpinBlowDown_Server::LookAt_HitObject(_float fTimeDelta)
{
...
void CState_Madara_HitSpinBlowDown_Server::Free()
{
	__super::Free();
}
